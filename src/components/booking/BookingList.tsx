    ...
    >
      ...
      <div className="flex items-center justify-between mb-8 relative z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-white uppercase tracking-widest">Currency Hub</h3>
        ...
        <div className="px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
          <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest animate-pulse">Live</span>
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative z-10">
        <div className="space-y-2">
          <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Amount (IDR)</label>
          <div className="relative">
            <input 
              type="number" 
              value={amount}
              onChange={(e) => setAmount(Number(e.target.value))}
              className="glass-input dark:glass-input-dark w-full rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none dark:text-white transition-all hover:bg-white/40 dark:hover:bg-slate-900/40"
            />
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-bold text-slate-400 uppercase">IDR</div>
          </div>
        </div>
        <div className="space-y-2">
          <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Target Currency</label>
          <div className="relative">
            <select 
              value={targetCurrency}
              onChange={(e) => setTargetCurrency(e.target.value)}
              className="glass-input dark:glass-input-dark w-full rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none dark:text-white appearance-none cursor-pointer transition-all hover:bg-white/40 dark:hover:bg-slate-900/40"
            >
      ...
      >
        <div className="flex flex-col">
          <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-400 uppercase tracking-widest mb-1">Estimated Value</span>
...
export default function BookingList() {
  ...
  const [selectedServiceForReview, setSelectedServiceForReview] = useState<any | null>(null);
  ...
  return (
    <div className="h-full w-full overflow-y-auto bg-mesh p-4 pb-32 relative transition-colors duration-300 no-scrollbar">
      <div className="mb-10 flex justify-between items-end relative z-10">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tight uppercase">Booking</h2>
        ...
        <div className="mb-14 relative z-10">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-white uppercase tracking-[0.25em]">
                  My Bookings
                </h3>
                ...
                >
                  ...
                  <div className="flex items-center gap-6 relative z-10 w-full sm:w-auto">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1.5">
                        <h4 className="font-bold text-slate-900 dark:text-white text-base tracking-tight">{booking.serviceTitle}</h4>
                        <div className={`px-3 py-1 rounded-full text-[8px] font-bold uppercase tracking-widest border border-white/20 ${getStatusColor(booking.status)}`}>
                          {booking.status}
                        </div>
                      </div>
                  ...
                  <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between w-full sm:w-auto mt-6 sm:mt-0 gap-4 relative z-10 pt-4 sm:pt-0 border-t sm:border-t-0 border-white/10">
                    <div className="text-right">
                      <p className="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-0.5">Total Paid</p>
                      <p className="text-lg font-bold text-slate-900 dark:text-white tracking-tighter">{booking.amount}</p>
                    </div>
                    ...
                    {booking.providerId === user.uid && booking.status === 'pending' && (
                      <div className="flex gap-2">
                        <button 
                          ...
                          className="text-[9px] font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 px-5 py-2.5 rounded-2xl transition-all uppercase tracking-widest border border-emerald-500/20 active:scale-95"
                        >
                          Confirm
                        </button>
                        <button 
                          onClick={() => handleUpdateStatus(booking.id, 'cancelled')}
                          className="text-[9px] font-bold text-rose-600 dark:text-rose-400 bg-rose-500/10 hover:bg-rose-500/20 px-5 py-2.5 rounded-2xl transition-all uppercase tracking-widest border border-rose-500/20 active:scale-95"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    {booking.status === 'confirmed' && (
                      <div className="flex items-center gap-2 text-emerald-500 dark:text-emerald-400">
                        <span className="text-[9px] font-bold uppercase tracking-widest">Ready to go</span>
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.6)]"></div>
                      </div>
                    )}

                    {booking.userId === user.uid && booking.status === 'confirmed' && (
                      <button 
          ...
          {featuredActivities.map((activity, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="font-bold text-slate-900 dark:text-white text-xl tracking-tight mb-3 group-hover:text-electric-blue dark:group-hover:text-electric-blue-light transition-colors duration-500">{activity.title}</h4>
              ...
              <div className="flex items-center justify-between relative z-10 pt-6 border-t border-white/10">
                <div className="flex flex-col">
                  <span className="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1">Price</span>
                  <span className="text-base font-bold text-slate-900 dark:text-white tracking-tight">{activity.price}</span>
                </div>
                <button className="bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-6 py-3 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-xl shadow-slate-900/10 dark:shadow-white/5 flex items-center gap-2 group/btn">
                  Explore
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-32 relative z-10">
          ...
          <div className="flex flex-col items-center gap-2">
            <p className="text-slate-900 dark:text-white text-sm font-bold uppercase tracking-[0.3em]">Syncing Data</p>
        ...
        >
          ...
          <h4 className="text-amber-800 dark:text-amber-200 font-bold uppercase tracking-tight text-xl mb-3">Connection Lost</h4>
          ...
          <button 
            ...
            className="mt-8 px-8 py-3.5 bg-amber-500 text-white rounded-2xl text-[10px] font-bold uppercase tracking-widest shadow-xl shadow-amber-500/20 active:scale-95 transition-all"
          >
            Retry Connection
          </button>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            <p className="font-bold text-slate-900 dark:text-white uppercase tracking-tight text-xl mb-2">Quiet on the Island</p>
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      <span className={`text-[10px] font-bold uppercase tracking-[0.3em] ${textColorClass} opacity-80 mb-2 block`}>
                        {item.type}
                      </span>
                      <h3 className="text-2xl font-bold text-slate-900 dark:text-white leading-tight group-hover:text-electric-blue dark:group-hover:text-electric-blue-light transition-colors duration-500 tracking-tight">
                        {item.title}
                      </h3>
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-3 pt-8 border-t border-white/10">
                      <div className="flex flex-col">
                        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1">Price per person</span>
                        <span className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white tracking-tighter">{item.price}</span>
                      </div>
                      
                      <div className="flex gap-2">
                        <button 
                          onClick={() => setSelectedServiceForReview(item)}
                          className="glass dark:glass-dark text-slate-600 dark:text-slate-300 p-5 rounded-[2rem] font-bold text-xs uppercase tracking-widest shadow-xl border border-white/30 active:scale-95 transition-all flex items-center justify-center"
                          title="View Reviews"
                        >
                        ...
                        <button 
                          ...
                          className="bg-electric-blue hover:bg-electric-blue-dark text-white py-5 px-8 rounded-[2rem] font-bold text-xs uppercase tracking-widest shadow-2xl shadow-electric-blue/30 active:scale-95 transition-all flex items-center justify-center gap-3 group/btn border border-white/30"
                        >
                          Book Now
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex justify-between items-center mb-8 relative z-10">
                <div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Reserve Spot</h3>
              ...
              <form onSubmit={(e) => { e.preventDefault(); setShowConfirmModal(true); }} className="relative z-10">
                <div className="space-y-6 mb-10">
                  <div className="space-y-2">
                    <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Select Date</label>
                    <div className="relative">
                      <input 
                        type="date" 
                        value={bookingDate}
                        ...
                        className="glass-input dark:glass-input-dark w-full rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none dark:text-white transition-all"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Arrival Time</label>
                      <input 
                        type="time" 
                        value={bookingTime}
                    ...
                    <div className="space-y-2">
                      <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Total Guests</label>
                      <input 
                        type="number" 
                        value={bookingGuests}
                  ...
                  <div className="bg-white/40 dark:bg-white/5 p-6 rounded-3xl border border-white/30 dark:border-white/10 backdrop-blur-md shadow-inner">
                    <div className="flex justify-between items-center mb-3">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Base Rate</span>
                      <span className="font-bold text-slate-900 dark:text-white">{isBooking.price}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Provider</span>
                ...
                <button 
                  ...
                  className="w-full bg-electric-blue hover:bg-electric-blue-dark text-white font-bold py-5 rounded-[2rem] shadow-2xl shadow-electric-blue/20 active:scale-95 transition-all flex items-center justify-center gap-3 group uppercase tracking-widest text-xs"
                >
                  Confirm Details
        ...
        {showConfirmModal && isBooking && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-8 uppercase tracking-tight">
              ...
              {!paymentStep ? (
                <>
                  <div className="space-y-5 mb-10 bg-white/40 dark:bg-white/5 p-6 rounded-[2rem] border border-white/30 dark:border-white/10 text-sm backdrop-blur-md shadow-inner">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Service</span>
                      <span className="font-bold text-slate-900 dark:text-white text-right tracking-tight">{isBooking.title}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Date</span>
                      <span className="font-bold text-slate-900 dark:text-white tracking-tight">{bookingDate}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Time</span>
                      <span className="font-bold text-slate-900 dark:text-white tracking-tight">{bookingTime}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Guests</span>
                      <span className="font-bold text-slate-900 dark:text-white tracking-tight">{bookingGuests}</span>
                    </div>
                    <div className="flex justify-between items-center pt-5 border-t border-slate-200/50 dark:border-white/10">
                      <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Total Amount</span>
                      <span className="text-2xl font-bold text-electric-blue dark:text-electric-blue-light tracking-tighter">{isBooking.price}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    <button 
                      onClick={() => setShowConfirmModal(false)}
                      className="flex-1 glass-input dark:glass-input-dark text-slate-600 dark:text-slate-300 font-bold py-4 rounded-2xl hover:bg-white/50 dark:hover:bg-white/10 transition-all uppercase tracking-widest text-[10px] border border-white/20"
                    >
                      Back
                    </button>
                    <button 
                      onClick={() => setPaymentStep(true)}
                      className="flex-1 bg-electric-blue hover:bg-electric-blue-dark text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] shadow-xl shadow-electric-blue/20 active:scale-95 border border-white/20"
                    >
                      Pay Now
                    </button>
                  </div>
                ...
                <div className="space-y-10">
                  <div className="p-8 bg-white/40 dark:bg-white/5 rounded-[2.5rem] border border-white/30 dark:border-white/10 backdrop-blur-md shadow-inner">
                    <div className="flex items-center gap-5 mb-8">
                      ...
                      <div>
                        <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Amount Due</p>
                        <p className="text-2xl font-bold text-slate-900 dark:text-white tracking-tighter">{isBooking.price}</p>
                      </div>
                    </div>
                    
                    <div className="space-y-4">
                      <div className="glass-input dark:glass-input-dark h-14 rounded-2xl px-6 flex items-center text-slate-900 dark:text-white text-xs font-bold tracking-[0.3em] border border-white/20">
                        •••• •••• •••• 4242
                      </div>
                  ...
                  <div className="flex gap-4">
                    <button 
                      ...
                      disabled={isPaying}
                      className="flex-1 glass-input dark:glass-input-dark text-slate-600 dark:text-slate-300 font-bold py-4 rounded-2xl hover:bg-white/50 dark:hover:bg-white/10 transition-all disabled:opacity-50 uppercase tracking-widest text-[10px] border border-white/20"
                    >
                      Back
                    </button>
                    <button 
                      ...
                      disabled={isPaying}
                      className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-4 rounded-2xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] shadow-xl shadow-emerald-600/20 active:scale-95 border border-white/20"
                    >
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex justify-between items-center mb-10 relative z-10">
                <div>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white uppercase tracking-tight">{editingItem ? 'Update Service' : 'New Service'}</h3>
              ...
              <form onSubmit={handleCreate} className="relative z-10">
                <div className="space-y-8 mb-12">
                  <div className="space-y-2">
                    <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Service Category</label>
                    <div className="relative">
                      <select 
                        value={formData.type}
                        onChange={(e) => {
                        ...
                        className="glass-input dark:glass-input-dark w-full rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none dark:text-white appearance-none cursor-pointer"
                      >
                  ...
                  <div className="space-y-2">
                    <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Display Title</label>
                    <input 
                      type="text" 
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Duration</label>
                      <input 
                        type="text" 
                        value={formData.time}
                    ...
                    <div className="space-y-2">
                      <label className="block text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Price (IDR)</label>
                      <input 
                        type="text" 
                ...
                <button 
                  ...
                  className="w-full bg-electric-blue hover:bg-electric-blue-dark text-white font-bold py-5 rounded-[2rem] shadow-2xl shadow-electric-blue/20 active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 uppercase tracking-widest text-xs"
                >
                  {isSubmitting ? (
                    <>
            ...
            >
              <div className="p-8 max-h-[80vh] overflow-y-auto no-scrollbar">
                <div className="flex justify-between items-center mb-8">
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tighter uppercase">Reviews: {selectedServiceForReview.title}</h3>
                  <button onClick={() => setSelectedServiceForReview(null)} className="p-2 text-slate-400"><X size={24} /></button>
                </div>
                <ReviewSystem targetId={selectedServiceForReview.id} targetType="service" />
              </div>
            </motion.div>
          </div>
        )}
